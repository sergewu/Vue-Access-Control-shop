...
<section>
  ...
  <el-row :span="24" class="toolbar" style="padding-bottom: 0px;">
    <el-form :inline="true" :model="filters" ref="filters">
      ...
      <el-form-item  style="float:right">
        <el-button type="primary" @click="handleAdd"><i class="el-icon-plus"></i> 新增公司账户</el-button>
      </el-form-item>
      <el-form-item  style="float:right">
  ...
  <el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;" border>
    <el-table-column prop="card_num" label="公司卡号">
    </el-table-column>
    <el-table-column prop="name" label="公司名称">
    </el-table-column>
    <el-table-column prop="address" label="公司地址">
    </el-table-column>
    <el-table-column prop="person" label="负责人姓名">
    </el-table-column>
    <el-table-column prop="phone" label="负责人电话">
    </el-table-column>
    <el-table-column prop="balance" label="余额￥">
    </el-table-column>
    <el-table-column prop="birth" width="330">
      <template slot-scope="scope">
					<el-button type="primary" size="small" @click="clickBind(scope.$index, scope.row)">绑定<i class="el-icon-edit el-icon--right"></i></el-button>
					<el-button type="success" size="small" @click="clickSee(scope.$index, scope.row)">已绑定会员</el-button>
          <el-button type="success" size="small" @click="clickRecharge(scope.$index, scope.row)">充值</el-button>
          <el-button :plain="true" type="info" size="small" @click="clickDetailed(scope.$index, scope.row)">操作记录</el-button>
				</template>
    </el-table-column>
  </el-table>
  <!--绑定会员-->
