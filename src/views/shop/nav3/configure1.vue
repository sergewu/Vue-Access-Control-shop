...
<section>
  ...
  <el-table :data="users" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
    ...
    <el-table-column prop="pnum" label="打印份数" min-width="120">
    </el-table-column>
  ...
  <!--详情界面-->
  <el-dialog title="打印详情" :visible.sync="detFormVisible" :close-on-click-modal="false">
  ...
  <!--新增界面-->
  <el-dialog title="新增打印机" :visible.sync="addFormVisible" :close-on-click-modal="false" size="tiny">
